        ...
        <div class="row">
            <div class="col-md-4 offset-md-4 form login-form">
                <form action="login.php" method="POST" autocomplete="">
                    ...
                    <div class="form-group">
                        <input class="form-control text-light button" type="submit" name="login" value="Login">
                    </div>
                    <div class="link login-link text-center">Not yet a member? <a class="font-weight-bold" href="index.php">Register here!</a></div>
                </form>
            </div>
        </div>
    </div>
